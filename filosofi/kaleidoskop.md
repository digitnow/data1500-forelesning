...
- Heidegger:
    - presence-at-hand (bare en observasjon av hammer)
    - readiness-to-hand (hammer i kontekst; maskiner kan ikke klare dette)
...
- Kontrafaktisk (stemmer ikke med det faktiske)

## Logikk 
- Utsagn
- Utsagns forhold til mulighet, virkelighet eller nødvendighet


## Om Gestalt begrepet i psykologien

### Sentrale bidragsytere
1. Max Wertheimer (persepsjon og tanke) https://en.wikipedia.org/wiki/Max_Wertheimer
2. Wolfgang Köhler (kritiserte introspeksjon fordi at det er ikke en objektiv erfaring og dermed ikke vitenskapelig; kritiserte også behaviorisme fordi at adferd kan tolkes forskjellig avhengig av hvem som observerer) https://en.wikipedia.org/wiki/Wolfgang_K%C3%B6hler 


## В. В. Петухов 
Валерий Викторович Петухов (15 сентября 1950, Болшево, г. Королёв, Московская область, СССР — 6 сентября 2003, Москва, Россия) https://ladycaramelka.ru/stati/petuhov-valeriy-viktorovich 

### Persepsjon og tenking
- Figur, bakgrunn, gestalt, fenomen (to punkter som blinker). 
- Tingens natur.
...
## Introspeksjon
Selvrapportering av bevisste tanker og følelser.


## Forståelse og problemløsning
### PROBLEMOMRÅDER i forståelsen av begreper
Kan ikke forstå noe for en annen. Hver enkel må forstå noe (alt) selv.

- «kan ikke skille mellom prosesser, og dermed har utfordringer til å forstå kommunikasjon mellom prosesser» 
- «kan ikke mentalt relatere begrepet image med begrepet container»
- «kan ikke forestille seg hierarkiske strukturer og navigere kognitivt i nivåer i slike strukturer» 


### VERKTØYKASSE FOR Å TAKLE PROBLEMOMRÅDER
- «retrieval»
- «forklare til andre» 
- «praktiske (reelle) oppgaver»

## Om politikk

### Konservativt, progressivt (og liberalt?)
A ***conservative*** is someone who believes that a minority of people were born to rule, and that everyone else was born to follow their rules, and that the world is in harmony when the born rulers are in charge.

***Progressives*** see a world in which only a small number of people rise to public life, rarified professions, and cultural prominence and assume that this is terrible waste of the talents and contributions of people whose accidents of birth keep them from participating in the same way.
...
# Referanser
Bidragsytere til Wikimedia-prosjektene. (2008, May 29). Paradoksal intensjon. Wikipedia.org; Wikimedia Foundation, Inc. https://no.wikipedia.org/wiki/Paradoksal_intensjon
